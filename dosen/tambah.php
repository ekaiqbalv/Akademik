...
<body>
    ...
    <div class="container">
        <div class="header-section mb-4">Tambah Data Dosen</div>
        <form action="../controllers/TambahDosenController.php" method="POST">
            ...
            <div class="form-group row mb-4">
                <label class="col-sm-2">Ruang Kerja</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="ruang_kerja" placeholder="Masukkan Ruang Kerja"
                        required>
                </div>
            </div>
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="tahunMasuk" placeholder="Masukkan Tahun Masuk"
                        required>
                </div>
            </div>
            <div class="form-group row mb-4">
                <label class="col-sm-2">Mengajar Mata Kuliah</label>
                <div class="col-sm-5">
                    <select class="form-control" name="matkul" required>
                        <option disabled selected>Pilih Mata Kuliah</option>
                        <?php 
                            foreach ((array)$result as $index=>$loop) {
                                echo "<option value=".$mataKuliah->readable($loop['data']['value']).">".$mataKuliah->readable($loop['kode']['value'])." ".$mataKuliah->readable($loop['nama']['value'])."</option>";
                            }
                        ?>
                    </select>
                </div>
