...
<body>
    ...
    <div class="container">
        <div class="header-section mb-4">Tambah Data Mahasiswa</div>
        <form action="../controllers/TambahMahasiswaController.php" method="POST">
            ...
            <div class="form-group row mb-4">
                <label class="col-sm-2">Belajar Mata Kuliah</label>
                <div class="col-sm-5">
